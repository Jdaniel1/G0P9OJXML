...
public class DomWriteG0P9OJ {
    ...
    private static void addMunkagep(Document doc, Element parent, String rendszam, String tulajJogsi,
        ...
        addChildElement(doc, munkagepElement, "tulaj_jogsi", tulajJogsi);
        addChildElement(doc, munkagepElement, "motor_szama", motorSzam);
        addChildElement(doc, munkagepElement, "alvaz_szama", alvazSzam);
        addChildElement(doc, munkagepElement, "gyartas_sorszam", gyartasSorszam);

        if (cascoAzon != null) {
            addChildElement(doc, munkagepElement, "casco_azon", cascoAzon);
        }
